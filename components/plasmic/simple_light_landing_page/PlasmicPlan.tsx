...
import BaseCard from "../../BaseCard"; // plasmic-import: gFNFWdO8cCUd/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: Tx_3sQz9ZjKs/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__lHdvV)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__w1JLt)}
        >
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__vFurg)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jNut)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__udxW)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__lIu9A)}
                />
              </Stack__>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox___1JiWu)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__uvfhR)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
