...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: 4mjQ83lumLeq/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zsQkn)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__zVx4J)}>
          <div className={classNames(projectcss.all, sty.freeBox__oStRi)}>
            {renderPlasmicSlot({
