...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: O9UzhynD5wo6/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: db-YNSKCBqUP/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cgvCr)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__lM7KC)}
        >
          <TextInput
      ...
      <div className={classNames(projectcss.all, sty.freeBox__oVWn7)}>
        <SphereIcon
