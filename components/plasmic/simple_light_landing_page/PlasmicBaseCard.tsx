...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: gFNFWdO8cCUd/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__pA6Gf, {
          [sty.freeBoxlong__pA6GfymxB]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___3OBof, {
          [sty.freeBoxlong___3OBofymxB]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__tl9Jl)}
              role={"img"}
            />
          ),
