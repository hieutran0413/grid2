...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: rnHyZgOf1cJa/css
...
function PlasmicFeatureCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ekpa0, {
          [sty.freeBoxlong__ekpa0CdqSl]: hasVariant($state, "long", "long")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__j4TsI, {
            [sty.freeBoxlong__j4TsIcdqSl]: hasVariant($state, "long", "long")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__xz2)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__u1Hgr, {
          [sty.freeBoxlong__u1HgrCdqSl]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___5Y63W, {
          [sty.freeBoxlong___5Y63WCdqSl]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__x06J)}
              role={"img"}
            />
          ),
