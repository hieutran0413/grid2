...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: H3BXtAoNnqrl/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__d53ZO)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ld7Ak)}
              role={"img"}
            />
          ),
