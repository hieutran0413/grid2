...
import Avatar from "../../Avatar"; // plasmic-import: hIIDlFiG9Gdr/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: oCIWVnI9gvbe/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: nJUzzkDd5w9H/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vLjUu)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__nKEdI)}
        >
          <div
            className={classNames(
              projectcss.all,
